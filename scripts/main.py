...
parser.add_argument('--data-folder',
                    default='/home/student/Desktop/Rahul/data/kitti_depth/depth',
                    type=str,
                    metavar='PATH',
                    help='data folder (default: none)')
parser.add_argument('--data-folder-rgb',
                    default='/media/student/HV620S/Rahul/data/dataset/kitti_raw',
                    type=str,
                    metavar='PATH',
                    help='data folder rgb (default: none)')
parser.add_argument('--data-folder-save',
                    default='/home/student/Desktop/Rahul/data/kitti_depth/submit_test/',
                    type=str,
                    metavar='PATH',
...
depth_criterion = criteria.MaskedMSELoss() if (
    args.criterion == 'l2') else criteria.MaskedRuberLoss()
