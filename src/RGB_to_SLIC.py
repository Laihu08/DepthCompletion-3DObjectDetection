...
#img = Image.open('/home/dsp528/Desktop/Rahul/Thesis_john/rgb_image_to_slic_image/000138.png').convert('LA')
...
#img.save('/home/dsp528/Desktop/Rahul/Thesis_john/rgb_image_to_slic_image/000138G.png') #add img_res.save
...
# path access
cwd = os.getcwd()
path_dir1 = cwd +"/rgb_image_from_camera"
path_dir2 = cwd +"/RGB_to_SLIC"
for filename in os.listdir(path_dir1):
    img = cv2.imread(os.path.join(path_dir1, filename))
# global variable

#img = cv2.imread('/home/dsp528/Desktop/Rahul/Thesis_john/rgb_image_to_slic_image/2011_09_26_drive_0002_sync_image_0000000005_image_02.png')

    step = int((img.shape[0]*img.shape[1]/int(20000))**0.5)
    SLIC_m = int(40)
    SLIC_ITERATIONS = 1
    ...
    cv2.waitKey(0)
    cv2.imwrite(path_dir2+'/'+filename, img)
